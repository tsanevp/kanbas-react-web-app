...
export default function TOC() {
  ...
  return (
    <ul className="nav nav-pills">
      ...
      <li className="nav-item"><a id="wd-github" href="https://github.com/tsanevp/kanbas-react-web-app/tree/a3" target="_blank" rel="noreferrer" className={`nav-link ${pathname.includes("Github") ? "active" : ""}`}>Github Repo</a></li>
    </ul>
  );
}  